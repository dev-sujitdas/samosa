...
const Button = ({ text, color, textColor, clickHandler, backgroundColor, link }) => {
  return (
    <Link to={link}>
    <div onClick={clickHandler} className={`cta-button w-fit px-2 py-2 flex justify-between items-center rounded-full shadow-lg cursor-pointer hover:shadow-xl group z-888`}

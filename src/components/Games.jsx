...
const floatImages = [
    { url: "/float-images/dice2.png", top: "50%", left: "85%", size: "10rem", rotation: "5deg" },
    { url: "/float-images/puzzle-piece.png", top: "25%", left: "10%", size: "15rem", rotation: "0deg" },
    { url: "/float-images/chess-piece.png", top: "90%", left: "75%", size: "15rem", rotation: "-40deg" },
    { url: "/float-images/chess-game2.png", top: "75%", left: "10%", size: "20rem", rotation: "20deg" },
];
    ...
    return (
        <section ref={containerRef} className="w-full h-full color-primary relative overflow-hidden">
            ...
            <div className="games w-full h-full flex flex-col items-center p-5 md:p-14 mb-10 relative">
                ...
                <div className="game-list w-full md:w-full xl:w-[70%] relative mt-10 p-5 md:p-0 md:mt-20 mb-10 flex justify-center flex-wrap gap-5">

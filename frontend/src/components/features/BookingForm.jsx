...
const BookingForm = ({ closeForm }) => {
  ...
  return (
    <section className='fixed top-0  w-full h-screen flex justify-center items-center z-999 bg-[#31303054] backdrop-blur-md p-20'>
      <div className='w-fit h-fit flex flex-col justify-center items-center relative'>
        ...
        <form
          ...
          className="w-lg mx-auto p-6 bg-[#FFCA15] shadow-md rounded-xl space-y-4 "
        >
          ...
          <div>
            <label className="block mb-1 poppins-medium">Notes (Optional)</label>
            <textarea
              name="notes"
              rows="3"
          ...
          <button
            type="submit"
            className="w-full bg-[#CA0000] poppins-semibold text-white py-2 rounded-full hover:opacity-90 transition"
          >
            Submit Booking
          </button>
        </form>
